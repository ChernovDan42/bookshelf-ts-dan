import { Link, useTheme, SvgIcon } from '@mui/material';
    ...
    <SvgIcon>
      ...
      >
        <g clipPath="url(#clip0_4313_467)">
          ...
          />
          <path
            d="M20.7999 20.7137L11.8428 11.8423L3.3999 3.22797H20.7999V20.7137Z"
            fill="#4F2EE8"
          />
          <path
            d="M6.94287 6.77142L11.7 11.5286L17.1429 16.9714H6.94287V6.77142Z"
            fill="#4F2EE8"
          />
          <path
            d="M6.94287 6.77142L11.7 11.5286L17.1429 16.9714V6.77142H6.94287Z"
            fill="#F6F6F6"
          />
        </g>
        <defs>
          <clipPath id="clip0_4313_467">
...
const BookshelfIcon = ({ theme }: Props) => {
  return (
...
export const Logo = () => {
  ...
  const fill = theme.palette.mode === 'light' ? '#000' : '#F3F3F3';
